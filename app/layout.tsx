...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokepbarat.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: 'a0iO9M1poim7iMPhh8X1uFamlHzws2BRrIXNv_kTVHI',
        yandex: '0b51414c87634a06',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "logo": "https://bokepbarat.pages.dev/favicon.ico",
        "url": "https://bokepbarat.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://bokepbarat.pages.dev"
        ...
        "url": "https://bokepbarat.pages.dev",
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "image": "https://bokepbarat.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokepbarat.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokepbarat.pages.dev/?q={search_term}", 
